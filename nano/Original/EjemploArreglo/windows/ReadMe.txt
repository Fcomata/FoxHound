========================================================================
    APLICACIÓN DE CONSOLA: EjemploArreglo Información general 
    del proyecto
========================================================================

AppWizard ha creado esta aplicación EjemploArreglo.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la EjemploArreglo aplicación.


EjemploArreglo.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado EjemploArreglo.pch y un archivo de 
